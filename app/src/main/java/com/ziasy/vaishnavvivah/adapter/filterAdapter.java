...
public class filterAdapter extends ArrayAdapter {
    ...
    public filterAdapter(Context context, ArrayList<Login_model.userdetail> al,int year) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        filterAdapter.ViewHolder vh = new filterAdapter.ViewHolder();
        int pos = position;
        ...
        if (convertView == null) {
            ...
            vh =(filterAdapter.ViewHolder)convertView.getTag();
        }
